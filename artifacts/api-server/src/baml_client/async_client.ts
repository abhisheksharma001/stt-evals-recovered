    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.AnalyzeFailure(
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.JudgeCandidates(
          originalTranscript,flaggedSpans,candidates,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "JudgeCandidates",
            {
            "originalTranscript": originalTranscript,"flaggedSpans": flaggedSpans,"candidates": candidates
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
            ...
            return __raw__.parsed(false) as types.JudgeVerdict
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            providerName: string,httpStatus?: number | null,errorMessage: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.FailureAnalysis, types.FailureAnalysis>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AnalyzeFailure", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.FailureAnalysis, types.FailureAnalysis>(
                  __raw__,
                  (a): partial_types.FailureAnalysis => a,
                  (a): types.FailureAnalysis => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            originalTranscript: string,flaggedSpans: types.FlaggedSpan[],candidates: types.Candidate[],
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.JudgeVerdict, types.JudgeVerdict>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for JudgeCandidates", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.JudgeVerdict, types.JudgeVerdict>(
                  __raw__,
                  (a): partial_types.JudgeVerdict => a,
                  (a): types.JudgeVerdict => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
