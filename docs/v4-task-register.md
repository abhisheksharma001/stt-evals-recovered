...
Batch 1 = T-31, T-76, T-80, T-82, T-84 (PR #49). Batch 2 = T-81, T-83, T-78, T-77, T-85 (PR #50). Batch 3 = next five ungated todo rows, top of the register down. Evidence for UI work comes from the global `visual-and-research` skill (Mobbin + Lenny's); each row names its reference.
